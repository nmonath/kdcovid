...
flags.DEFINE_string('outfile', '2020-04-10/cached_results.html', 'out path')
...
def format(task2subtasks, subtasks_html, css):
...
def main(argv):
    ...
    search_tool = SearchTool(data_dir=FLAGS.data_dir)
    ...
    html_output = format(task_questions.task2questions, results, css)
